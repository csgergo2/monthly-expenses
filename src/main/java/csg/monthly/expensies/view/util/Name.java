...
public enum Name {
    ...
    FILTERING_YEAR_FILTER_LABEL(10, 10, 25, 25),
    FILTERING_YEAR_FILTER(45, 10, 100, 25),
    FILTERING_MONTH_FILTER_LABEL(155, 10, 25, 25),
    FILTERING_MONTH_FILTER(190, 10, 100, 25),
    FILTERING_DATE_START_LABEL(300, 10, 80, 25),
    FILTERING_DATE_START(390, 10, 80, 25),
    FILTERING_DATE_END_LABEL(480, 10, 65, 25),
    FILTERING_DATE_END(555, 10, 80, 25),
    FILTERING_NAME_FILTER_LABEL(10, 45, 25, 25),
    FILTERING_NAME_FILTER(45, 45, 200, 25),
    FILTERING_TAG_FILTER_LABEL(255, 45, 25, 25),
    FILTERING_TAG_FILTER(290, 45, 100, 25),
    FILTERING_INCOME_FILTER_LABEL(400, 45, 50, 25),
    FILTERING_INCOME_FILTER(460, 45, 25, 25),
    FILTERING_FILTER_BUTTON(10, 80, 100, 25),
    FILTERING_PANEL_BACK_BUTTON(120, 80, 100, 25),
    FILTERING_ITEMS(10, 115, 1000, 500),
    FILTERING_SUMMARIZE_LABEL(10, 625, 500, 25),
